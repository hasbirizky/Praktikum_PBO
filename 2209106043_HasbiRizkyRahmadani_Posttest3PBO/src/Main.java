...
public class Main {
    ...
    static void CreateMakanan() throws NumberFormatException, IOException{
        ...
        Makanan newMakanan = new Makanan(nama_makanan, harga_makanan, "Makanan", desk_makanan);
        resto.addMakanan(newMakanan);
        System.out.println("");
    ...
    static void CreateMinuman() throws NumberFormatException, IOException{
        ...
        Minuman newMinuman = new Minuman(nama_minuman, harga_minuman, "Minuman", desk_minuman);
        resto.addMinuman(newMinuman);
        System.out.println("");
    ...
    static void CreateSnack() throws NumberFormatException, IOException{
        ...
        Snack newSnack = new Snack(nama_snack, harga_snack, "Snack", desk_snack);
        resto.addSnack(newSnack);
        System.out.println("");
