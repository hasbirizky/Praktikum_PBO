...
public class Main {
    ...
    static void DisplayMenu(){
        ...
        if(DataMenu.isEmpty()){
            ...
            for(int i = 0; i < DataMenu.size(); i++){
                ...
                System.out.println(DataMenu.get(i).getNama());
                System.out.println("   " + DataMenu.get(i).getKatagori());
                System.out.println("   " + DataMenu.get(i).getHarga());
                System.out.println("   " + DataMenu.get(i).getDesk());
            }
        }
    }
    ...
    static void DeleteMenu() throws NumberFormatException, IOException{
        ...
        boolean menuFound = false;
        for(int i = 0; i < DataMenu.size(); i++){
            if(DataMenu.get(i).getNama().equals(namamenu)){
                menuFound = true;
                DataMenu.remove(i);
                System.out.println("");
